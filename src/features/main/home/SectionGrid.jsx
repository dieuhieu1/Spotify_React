...
import SectionGridSkeleton from "@/LoadingSkel/SectionGridSkeleton";

import PlayButtonSong from "./PlayBtnSong";
import PlayButtonPlaylist from "./PlayButtonPlaylist";
import { useNavigate } from "react-router-dom";
import PlayButtonArtist from "./PlayBtnArtists";
    ...
    <div className="mb-8">
      ...
      {songs && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[repeat(6,_200px)] gap-4">
          {songs
            ?.slice(0, 5) // Giới hạn chỉ lấy 4 phần tử
            .map((song) => (
              <div
                key={song?.id}
